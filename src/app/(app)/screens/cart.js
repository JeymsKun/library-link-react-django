...
const BookCard = ({ book, onRemove, onBorrow, onReserve, removingBookId, bookStatus }) => {
    ...
    const imageUrl = book.images?.[0] || book.cover_image || book.cover_image_url || book.image_urls?.[0];
        ...
        <View style={styles.bookCard}>
            ...
            <View style={styles.actionButtons}>
                <Button
                    ...
                    style={[styles.removeButton, (isRemoving || removingBookId === book.id) && styles.disabledButton]}
                    textColor="#dc3545"
...
const CartScreen = () => {
    ...
    const fetchCartItems = async () => {
        try {
            ...
            console.log('Cart items response:', JSON.stringify(response.data, null, 2));
    ...
    const confirmBorrow = async () => {
        ...
        try {
            ...
            const errorMessage = err.response?.data?.detail ||
                (err.response?.status === 400 ? 'Book is already borrowed' : 'Failed to borrow book');
    ...
    const confirmReserve = async () => {
        ...
        try {
            ...
            const errorMessage = err.response?.data?.detail ||
                (err.response?.status === 400 ? 'Book is already reserved' : 'Failed to reserve book');
            Alert.alert('Error', errorMessage);
        } finally {
        ...
        <SafeAreaView style={styles.safeArea} edges={['bottom']}>
            ...
            <Portal>
                ...
                >
                    ...
                    <View style={styles.modalButtons}>
                        <Button mode="outlined" onPress={() => setBorrowModalVisible(false)} style={styles.modalButton}>
                            Cancel
                        </Button>
                        <Button mode="contained" onPress={confirmBorrow} style={styles.modalButton}>
                            Confirm
                        </Button>
                    </View>
                </Modal>
            ...
            <Portal>
                ...
                >
                    ...
                    <Text style={styles.modalText}>Book: {selectedBook?.title}</Text>
                    <View style={styles.modalButtons}>
                        <Button mode="outlined" onPress={() => setReserveModalVisible(false)} style={styles.modalButton}>
                            Cancel
                        </Button>
                        <Button mode="contained" onPress={confirmReserve} style={styles.modalButton}>
                            Confirm
                        </Button>
                    </View>
                </Modal>
